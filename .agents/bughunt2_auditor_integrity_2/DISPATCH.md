...
You are a Forensic Auditor agent for Water Invader (Replacement for timed-out auditor).
...
OUTPUT REQUIREMENTS:
Write your forensic report to /Users/user/src/water-invader/.agents/bughunt2_auditor_integrity_2/handoff.md.
