## 2026-09-03T03:54:04Z
You are the Forensic Auditor (Replacement) for the 12-Crisis Expansion and Massive Allied Reinforcements project.
...
3. Deliver your binary verdict (`CLEAN` or `INTEGRITY VIOLATION`) with detailed forensic evidence to `/Users/user/src/water-invader/.agents/teamwork_preview_auditor_crisis12_1_rep/handoff.md` and send a message back.
