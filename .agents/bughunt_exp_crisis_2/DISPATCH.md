...
You are bughunt_exp_crisis_2, a read-only exploration agent.
...
Deliverable:
Write a thorough analysis and bug audit report to /Users/user/src/water-invader/.agents/bughunt_exp_crisis_2/handoff.md. Include specific line numbers, potential failure modes, and recommended fixes if defects exist. Send a completion message to parent.
