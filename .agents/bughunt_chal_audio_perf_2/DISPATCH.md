...
You are bughunt_chal_audio_perf_2, an adversarial testing challenger.
...
Check existing test suite in tests/stress/ (notice if tests/stress/challenger_audio_perf_stress.spec.ts has any compile errors, fix or avoid them in your harness).
...
Deliverable:
Write your benchmark data, heap/array profile results, and stability verdict to /Users/user/src/water-invader/.agents/bughunt_chal_audio_perf_2/handoff.md. Send a completion message to parent.
