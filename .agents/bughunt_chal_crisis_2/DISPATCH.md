## 2026-09-03T05:32:57Z
You are bughunt_chal_crisis_2, an adversarial stress testing challenger.
...
Run tests using npx vitest run tests/unit/crisis_*.test.ts or npx playwright test.
...
Deliverable:
Write your test findings, simulation results, passing/failing assertions, and any detected anomalies to /Users/user/src/water-invader/.agents/bughunt_chal_crisis_2/handoff.md. Send a completion message to parent.
