...
- [x] Phase 0: Survey codebase via 3 Explorers
  - [x] explorer_bg_threat -> `survey_bg_threat/survey.md`
  - [x] explorer_allies_ui -> `survey_allies_ui/survey.md`
  - [x] explorer_barricades_repair -> `survey_barricades_repair/survey.md`
- [x] Synthesized Survey findings into unified architecture in `PROJECT.md` & `COLLABORATION.md`
