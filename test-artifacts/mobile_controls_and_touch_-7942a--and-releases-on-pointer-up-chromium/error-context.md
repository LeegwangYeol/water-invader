...
- Name: mobile_controls_and_touch_evasion.spec.ts >> Mobile Touch & Drag Evasion Controls Suite >> R1: Pointer drag event triggers shooting while active and releases on pointer up
- Location: tests/mobile_controls_and_touch_evasion.spec.ts:88:7
