...
- Name: m1_verification.spec.ts >> Milestone 1: Core Engine & Collision Fixes Verification Suite >> F-08 [HIGH]: Near-miss suppression triggers only once per bullet (hasTriggeredNearMiss)
- Location: tests/m1_verification.spec.ts:203:7
