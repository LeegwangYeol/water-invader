...
- Name: enemy_y_boundary_and_dive_fixes.spec.ts >> Enemy Y-Axis Boundary & Dive Mechanic Fixes Suite (R1 & R2) >> R3-16: Defense breach penalty strictly resets player combo to 0 and updates score UI
- Location: tests/enemy_y_boundary_and_dive_fixes.spec.ts:576:7
