...
- Name: enemy_y_boundary_and_dive_fixes.spec.ts >> Enemy Y-Axis Boundary & Dive Mechanic Fixes Suite (R1 & R2) >> R3-18: 1000-Frame continuous stress across all enemy movement patterns with zero NaN and zero out-of-bounds
- Location: tests/enemy_y_boundary_and_dive_fixes.spec.ts:632:7
