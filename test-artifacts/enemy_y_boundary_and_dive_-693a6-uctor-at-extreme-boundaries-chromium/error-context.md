...
- Name: enemy_y_boundary_and_dive_fixes.spec.ts >> Enemy Y-Axis Boundary & Dive Mechanic Fixes Suite (R1 & R2) >> R3-15: Boss and Splitter size re-clamping immediately in constructor at extreme boundaries
- Location: tests/enemy_y_boundary_and_dive_fixes.spec.ts:548:7
