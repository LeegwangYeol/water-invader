...
- Name: m3_verification.spec.ts >> Milestone 3: UI/UX, HiDPI Scaling, Audio/Visual FX & Boss Polish Verification Suite >> F-11 [HIGH]: Retina & HiDPI Canvas Scaling supports window.devicePixelRatio
- Location: tests/m3_verification.spec.ts:30:7
