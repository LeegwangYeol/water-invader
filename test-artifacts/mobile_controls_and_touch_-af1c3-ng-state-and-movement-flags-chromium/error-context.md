...
- Name: mobile_controls_and_touch_evasion.spec.ts >> Mobile Touch & Drag Evasion Controls Suite >> R1 Adversarial: PointerCancel event cleanly resets drag state, shooting state, and movement flags
- Location: tests/mobile_controls_and_touch_evasion.spec.ts:384:7
