...
- Name: m3_verification.spec.ts >> Milestone 3: UI/UX, HiDPI Scaling, Audio/Visual FX & Boss Polish Verification Suite >> F-14 [HIGH]: Boss HP Bar renders when Boss is alive
- Location: tests/m3_verification.spec.ts:86:7
