...
- Name: mobile_controls_and_touch_evasion.spec.ts >> Mobile Touch & Drag Evasion Controls Suite >> R1 Adversarial: Window blur during active pointer drag cleanly resets all dragging and movement flags
- Location: tests/mobile_controls_and_touch_evasion.spec.ts:434:7
