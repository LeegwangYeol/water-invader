...
- Name: enemy_y_boundary_and_dive_fixes.spec.ts >> Enemy Y-Axis Boundary & Dive Mechanic Fixes Suite (R1 & R2) >> R2-01: Diver plunge attack trigger, safe trajectory acceleration, and boundary containment
- Location: tests/enemy_y_boundary_and_dive_fixes.spec.ts:81:7
