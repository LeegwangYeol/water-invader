...
- Name: mobile_controls_and_touch_evasion.spec.ts >> Mobile Touch & Drag Evasion Controls Suite >> R2: Top HUD buttons (MUTE) are clickable without interfering with canvas or dragging
- Location: tests/mobile_controls_and_touch_evasion.spec.ts:152:7
