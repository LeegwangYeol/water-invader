...
- Name: enemy_y_boundary_and_dive_fixes.spec.ts >> Enemy Y-Axis Boundary & Dive Mechanic Fixes Suite (R1 & R2) >> R3-17: Diver horizontal bounds containment and trajectory stability during plunge
- Location: tests/enemy_y_boundary_and_dive_fixes.spec.ts:603:7
