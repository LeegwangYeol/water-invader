...
- Name: enemy_y_boundary_and_dive_fixes.spec.ts >> Enemy Y-Axis Boundary & Dive Mechanic Fixes Suite (R1 & R2) >> R2-11: Negative initial coordinates and negative speed impulses are clamped to upper boundary (Y >= 0)
- Location: tests/enemy_y_boundary_and_dive_fixes.spec.ts:429:7
