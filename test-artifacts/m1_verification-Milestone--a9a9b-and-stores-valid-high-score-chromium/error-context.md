...
- Name: m1_verification.spec.ts >> Milestone 1: Core Engine & Collision Fixes Verification Suite >> F-15 [MEDIUM]: Corrupted localStorage NaN recovery falls back to 0 and stores valid high score
- Location: tests/m1_verification.spec.ts:237:7
