...
- Name: enemy_y_boundary_and_dive_fixes.spec.ts >> Enemy Y-Axis Boundary & Dive Mechanic Fixes Suite (R1 & R2) >> R2-14: Splitter mini-enemies spawn strictly inside canvas boundaries at extreme edges
- Location: tests/enemy_y_boundary_and_dive_fixes.spec.ts:512:7
