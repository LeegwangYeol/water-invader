...
- Name: stress/challenger_piercing_particle_empirical.spec.ts >> Challenger Empirical Verification: G-01 Piercing & G-04 Particle Pooling >> G-01 [EMPIRICAL 4]: Standard Bullet (Piercing=1) destroys on first enemy and does not touch subsequent enemies
- Location: tests/stress/challenger_piercing_particle_empirical.spec.ts:210:7
