...
- Name: m2_verification.spec.ts >> Milestone 2: Gameplay Mechanics, Upgrades & Controls Verification Suite >> F-12 [HIGH]: CapsLock and uppercase key events correctly control movement, skills, and cheats
- Location: tests/m2_verification.spec.ts:173:7
