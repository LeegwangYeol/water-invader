...
- Name: enemy_y_boundary_and_dive_fixes.spec.ts >> Enemy Y-Axis Boundary & Dive Mechanic Fixes Suite (R1 & R2) >> R1-02: Zigzag enemy horizontal oscillation while strictly clamped at bottom Y bound
- Location: tests/enemy_y_boundary_and_dive_fixes.spec.ts:48:7
