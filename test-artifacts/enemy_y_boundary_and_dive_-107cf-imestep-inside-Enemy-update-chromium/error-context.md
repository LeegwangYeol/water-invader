...
- Name: enemy_y_boundary_and_dive_fixes.spec.ts >> Enemy Y-Axis Boundary & Dive Mechanic Fixes Suite (R1 & R2) >> R2-12: Massive lag spike (deltaTime = 0.5s) is capped to 0.1s timestep inside Enemy.update
- Location: tests/enemy_y_boundary_and_dive_fixes.spec.ts:458:7
