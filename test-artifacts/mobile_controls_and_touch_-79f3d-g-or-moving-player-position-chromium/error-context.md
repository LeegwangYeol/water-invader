...
- Name: mobile_controls_and_touch_evasion.spec.ts >> Mobile Touch & Drag Evasion Controls Suite >> R2: Mobile button controls (ALLY, ULT, FIRE) operate without breaking or moving player position
- Location: tests/mobile_controls_and_touch_evasion.spec.ts:111:7
