...
- Name: m1_verification.spec.ts >> Milestone 1: Core Engine & Collision Fixes Verification Suite >> F-04 [HIGH]: Player i-Frames (invincibilityTimer) protects from consecutive damage and decrements in update
- Location: tests/m1_verification.spec.ts:72:7
