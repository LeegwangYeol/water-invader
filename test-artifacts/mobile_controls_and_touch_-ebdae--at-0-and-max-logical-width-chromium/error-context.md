...
- Name: mobile_controls_and_touch_evasion.spec.ts >> Mobile Touch & Drag Evasion Controls Suite >> R1: Extreme horizontal drag respects boundary clamping at 0 and max logical width
- Location: tests/mobile_controls_and_touch_evasion.spec.ts:61:7
