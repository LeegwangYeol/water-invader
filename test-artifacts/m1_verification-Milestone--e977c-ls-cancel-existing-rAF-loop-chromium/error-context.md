...
- Name: m1_verification.spec.ts >> Milestone 1: Core Engine & Collision Fixes Verification Suite >> F-02 [CRITICAL]: Repeated start/startGame calls cancel existing rAF loop
- Location: tests/m1_verification.spec.ts:42:7
