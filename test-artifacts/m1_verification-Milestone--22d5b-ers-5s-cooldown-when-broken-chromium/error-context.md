...
- Name: m1_verification.spec.ts >> Milestone 1: Core Engine & Collision Fixes Verification Suite >> F-06 [HIGH]: Shielded enemy absorbs damage via shieldHp first and triggers 5s cooldown when broken
- Location: tests/m1_verification.spec.ts:121:7
