...
- Name: m3_verification.spec.ts >> Milestone 3: UI/UX, HiDPI Scaling, Audio/Visual FX & Boss Polish Verification Suite >> F-14 [HIGH]: Hit Flash FX — Player & Enemy hitFlashTimer decrements on update and activates on damage
- Location: tests/m3_verification.spec.ts:122:7
