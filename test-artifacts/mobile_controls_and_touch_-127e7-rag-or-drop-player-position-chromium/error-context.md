...
- Name: mobile_controls_and_touch_evasion.spec.ts >> Mobile Touch & Drag Evasion Controls Suite >> R1 & R2 Adversarial: Simultaneous canvas drag and button tap (Ally/Ult) does not cancel drag or drop player position
- Location: tests/mobile_controls_and_touch_evasion.spec.ts:312:7
