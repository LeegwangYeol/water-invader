...
- Name: enemy_y_boundary_and_dive_fixes.spec.ts >> Enemy Y-Axis Boundary & Dive Mechanic Fixes Suite (R1 & R2) >> R2-05: Enemy reaching bottom boundary is gracefully despawned with breach penalty
- Location: tests/enemy_y_boundary_and_dive_fixes.spec.ts:212:7
