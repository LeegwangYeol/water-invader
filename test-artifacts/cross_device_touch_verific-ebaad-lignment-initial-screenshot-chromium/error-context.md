...
- Name: cross_device_touch_verification.spec.ts >> Cross-Device Touch Verification: Samsung Galaxy Z Fold >> 1. Initial state alignment & initial screenshot
- Location: tests/cross_device_touch_verification.spec.ts:70:9
