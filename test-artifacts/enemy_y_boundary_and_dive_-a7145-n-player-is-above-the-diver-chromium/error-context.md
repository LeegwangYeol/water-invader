...
- Name: enemy_y_boundary_and_dive_fixes.spec.ts >> Enemy Y-Axis Boundary & Dive Mechanic Fixes Suite (R1 & R2) >> R2-08: Diver does NOT trigger downward dive when player is above the diver
- Location: tests/enemy_y_boundary_and_dive_fixes.spec.ts:326:7
