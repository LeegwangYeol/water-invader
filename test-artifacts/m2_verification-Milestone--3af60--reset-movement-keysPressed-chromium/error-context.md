...
- Name: m2_verification.spec.ts >> Milestone 2: Gameplay Mechanics, Upgrades & Controls Verification Suite >> F-03 [CRITICAL]: Blur and visibilitychange events call clearKeys() to reset movement/keysPressed
- Location: tests/m2_verification.spec.ts:10:7
