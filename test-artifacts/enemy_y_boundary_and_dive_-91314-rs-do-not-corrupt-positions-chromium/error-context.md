...
- Name: enemy_y_boundary_and_dive_fixes.spec.ts >> Enemy Y-Axis Boundary & Dive Mechanic Fixes Suite (R1 & R2) >> R2-07: NaN canvas dimensions and invalid speed multipliers do not corrupt positions
- Location: tests/enemy_y_boundary_and_dive_fixes.spec.ts:293:7
