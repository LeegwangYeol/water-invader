...
- Name: enemy_y_boundary_and_dive_fixes.spec.ts >> Enemy Y-Axis Boundary & Dive Mechanic Fixes Suite (R1 & R2) >> R2-09: Multiple simultaneous divers under fluctuating deltaTimes (240 FPS to lag spikes)
- Location: tests/enemy_y_boundary_and_dive_fixes.spec.ts:348:7
