...
- Name: enemy_y_boundary_and_dive_fixes.spec.ts >> Enemy Y-Axis Boundary & Dive Mechanic Fixes Suite (R1 & R2) >> R2-13: Enemy ramming player resets combo to 0 and updates score UI
- Location: tests/enemy_y_boundary_and_dive_fixes.spec.ts:482:7
