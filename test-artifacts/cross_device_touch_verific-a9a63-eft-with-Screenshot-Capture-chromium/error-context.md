...
- Name: cross_device_touch_verification.spec.ts >> Cross-Device Touch Verification: Samsung Galaxy Z Fold >> 2. 1:1 Responsive Touch Dragging Right & Left with Screenshot Capture
- Location: tests/cross_device_touch_verification.spec.ts:83:9
